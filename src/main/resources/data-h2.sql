...
insert into couriers (id, name, phone_number, available) values (1, 'Dan', '0777777777', 'true');
insert into couriers (id, name, phone_number, available) values (2, 'Adrian', '0777888888', 'true');
